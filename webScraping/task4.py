...
def movie_details(link):
	...
	if os.path.exists("/home/somesh/Desktop/web_data/"+file_name):
	...
	##This will store all the Details of the movie
		dict_of_dir = {"Directors":[],"Language":[],"Country":"","Runtime":"","Bio":"","genres":[],"poster_url":"",'name':""}#This will store All the details about the movie
...
# 	return dict_of_dir
		...
		open_file = open("/home/somesh/Desktop/web_data/"+file_name,'w+')
